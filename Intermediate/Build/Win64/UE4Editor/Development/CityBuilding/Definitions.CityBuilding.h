...
#define UE_PROJECT_NAME CityBuilding
#define UE_TARGET_NAME CityBuildingEditor
#define UE_MODULE_NAME "CityBuilding"
...
#define CITYBUILDING_API DLLEXPORT
