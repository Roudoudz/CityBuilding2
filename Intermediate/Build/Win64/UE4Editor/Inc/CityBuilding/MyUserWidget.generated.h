...
#ifdef CITYBUILDING_MyUserWidget_generated_h
...
#define CityBuilding_Source_CityBuilding_UI_MyUserWidget_h_15_RPC_WRAPPERS \
 \
	...
	DECLARE_FUNCTION(execButtonHouse_Pressed); \
	DECLARE_FUNCTION(execButtonRail_Pressed); \
...
public: \
	DECLARE_CLASS(UMyUserWidget, UUserWidget, COMPILED_IN_FLAGS(0), CASTCLASS_None, TEXT("/Script/CityBuilding"), NO_API) \
...
template<> CITYBUILDING_API UClass* StaticClass<class UMyUserWidget>();

#undef CURRENT_FILE_ID
#define CURRENT_FILE_ID CityBuilding_Source_CityBuilding_UI_MyUserWidget_h
